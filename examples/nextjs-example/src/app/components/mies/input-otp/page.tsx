      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-6">
          <div className="space-y-2">
            <h1 className="text-5xl font-bold tracking-tight">Input Otp</h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              The Input Otp component from @tanqory/mies library.
              This page demonstrates the usage and features of the Input Otp component.
            </p>
          </div>
          ...
          <CardContent className="p-6">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                The Input Otp component is part of the @tanqory/mies component library.
            ...
            <div className="space-y-4">
              ...
              <div className="border rounded-lg p-4 bg-muted/20">
                <p className="text-center text-muted-foreground">
                  Input Otp component examples will be shown here.
                  This page demonstrates the component structure and can be customized
                  with specific examples for the Input Otp component.
                </p>
              </div>
              <div className="bg-muted p-4 rounded-lg">
                <pre className="text-sm"><code>{`// Basic usage
import { InputOtp } from '@tanqory/mies';
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                Detailed API documentation for the Input Otp component will be available here.
