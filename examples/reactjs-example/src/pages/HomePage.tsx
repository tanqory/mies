      ...
      <div className="text-center space-y-6">
        <div className="space-y-4">
          <Badge variant="secondary" className="px-3 py-1">
            React.js 19 • Create React App • TypeScript
          </Badge>
        ...
        <div className="flex gap-4 justify-center">
          <Button size="lg" onClick={() => onNavigate('/components')}>
            <LucideIcons.Rocket className="mr-2 h-4 w-4" />
            Explore Components
          </Button>
          <Button variant="outline" size="lg" onClick={() => window.open('https://github.com/tanqory/mies', '_blank')}>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {coreComponents.map((feature) => {
              ...
              return (
                <div key={feature.name} onClick={() => onNavigate(feature.href)}>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="text-center space-y-4">
              <div className="flex gap-4 justify-center">
                ...
                <Button variant="outline" onClick={() => window.open('https://storybook.tanqory.com', '_blank')}>
                  View Storybook
                </Button>
              </div>
              <p className="text-sm text-muted-foreground">
                Built with React.js 19, TypeScript, and Tailwind CSS
              </p>
            </div>
          </CardContent>
        </Card>
