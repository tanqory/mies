      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-6">
          <div className="space-y-2">
            <h1 className="text-5xl font-bold tracking-tight">Alert Dialog</h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              The Alert Dialog component from @tanqory/mies library.
              This page demonstrates the usage and features of the Alert Dialog component.
            </p>
          </div>
          ...
          <CardContent className="p-6">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                The Alert Dialog component is part of the @tanqory/mies component library.
            ...
            <div className="space-y-4">
              ...
              <div className="border rounded-lg p-4 bg-muted/20">
                <p className="text-center text-muted-foreground">
                  Alert Dialog component examples will be shown here.
                  This page demonstrates the component structure and can be customized
                  with specific examples for the Alert Dialog component.
                </p>
              </div>
              <div className="bg-muted p-4 rounded-lg">
                <pre className="text-sm"><code>{`// Basic usage
import { AlertDialog } from '@tanqory/mies';
...
function Example() {
  return <AlertDialog />;
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              <h3 className="text-lg font-semibold">AlertDialog</h3>
              <p className="text-muted-foreground">
                Detailed API documentation for the Alert Dialog component will be available here.
