...
export default function FoundationPage({ onNavigate }: FoundationPageProps) {
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {foundationCategories.map((category) => {
            ...
            return (
              <div key={category.name} onClick={() => onNavigate(category.href)}>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <IconsDemo />
          <div className="text-center">
            <Button variant="outline" onClick={() => onNavigate('/foundation/icons')}>
              View All Icons
            </Button>
          </div>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="text-center">
            <Button variant="outline" onClick={() => onNavigate('/foundation/grid')}>
              View Grid Examples
            </Button>
          </div>
        </CardContent>
