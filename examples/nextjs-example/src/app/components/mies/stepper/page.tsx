      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-6">
          <div className="space-y-2">
            <h1 className="text-5xl font-bold tracking-tight">Stepper</h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              The Stepper component from @tanqory/mies library.
              This page demonstrates the usage and features of the Stepper component.
            </p>
          </div>
          ...
          <CardContent className="p-6">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                The Stepper component is part of the @tanqory/mies component library.
            ...
            <div className="space-y-4">
              ...
              <div className="border rounded-lg p-4 bg-muted/20">
                <p className="text-center text-muted-foreground">
                  Stepper component examples will be shown here.
                  This page demonstrates the component structure and can be customized
                  with specific examples for the Stepper component.
                </p>
              </div>
              <div className="bg-muted p-4 rounded-lg">
                <pre className="text-sm"><code>{`// Basic usage
import { Stepper } from '@tanqory/mies';
...
function Example() {
  return <Stepper />;
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              <h3 className="text-lg font-semibold">Stepper</h3>
              <p className="text-muted-foreground">
                Detailed API documentation for the Stepper component will be available here.
