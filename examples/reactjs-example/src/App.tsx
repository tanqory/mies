      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">React.js 18 Example - Component Showcase</p>
          </div>
          <ThemeToggle />
        </div>
        ...
        <Alert>
          ...
          <AlertDescription>
            This is a demonstration of the @tanqory/mies component library running in React 18.
          </AlertDescription>
        </Alert>
        ...
        <div className="text-center text-muted-foreground">
          ...
          <p className="text-sm mt-1">React.js 18 • Create React App • TypeScript</p>
        </div>
      </div>
    </main>
  );
