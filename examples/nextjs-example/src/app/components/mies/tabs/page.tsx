        ...
        <div className="text-center space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              The Tabs component from @tanqory/mies library.
              This page demonstrates the usage and features of the Tabs component.
            </p>
          </div>
          ...
          <CardContent className="p-6">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                The Tabs component is part of the @tanqory/mies component library.
            ...
            <div className="space-y-4">
              ...
              <div className="border rounded-lg p-4 bg-muted/20">
                <p className="text-center text-muted-foreground">
                  Tabs component examples will be shown here.
                  This page demonstrates the component structure and can be customized
                  with specific examples for the Tabs component.
                </p>
              </div>
              <div className="bg-muted p-4 rounded-lg">
                <pre className="text-sm"><code>{`// Basic usage
import { Tabs } from '@tanqory/mies';
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground">
                Detailed API documentation for the Tabs component will be available here.
